...
public://methods
	...
	void calc_from_isoradials(std::map<double, std::pair<int, Isoradial*> >, bool cartesian = false);
	...
	std::pair<std::map<double, std::pair<std::vector<double>, std::vector<double>>>, std::map<double, std::pair<std::vector<double>, std::vector<double>>> > split_co_on_solutions();
...
private://variables
	...
	std::unordered_map<double, std::pair<std::vector<double>, std::vector<double>>> radii_w_coordinates_dict;
	std::unordered_map<double, std::pair<std::vector<double>, std::vector<double>>> coordinates_with_radii_dict;
...
private://methods
	...
	void add_solution(double angle, double radius_b, double radius_ir);
	std::unordered_map< double, std::pair<std::vector<double>, std::vector<double> > > init_co_to_radii_dict();
	void get_ir_radii_with_co();
